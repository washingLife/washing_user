...
class UserAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_address" do
    assert_difference('UserAddress.count') do
      post user_addresses_url, params: { user_address: { name: @user_address.name, user_id: @user_address.user_id } }
    end
  ...
  test "should update user_address" do
    patch user_address_url(@user_address), params: { user_address: { name: @user_address.name, user_id: @user_address.user_id } }
